        ...
        <div id="drum-machine">
            <div id="displayGrid">
                <text id="display"></text>
                    <div onClick={playH1} id="heater1" className="drum-pad btn">
                    ...
                    <div onClick={playH2} id="heater2" className="drum-pad btn">
                    ...
                    <div onClick={playH3} id="heater3" className="drum-pad btn">
                    ...
                    <div onClick={playH4} id="heater4" className="drum-pad btn">
                    ...
                    <div onClick={playClap} id="clap" className="drum-pad btn">
                    ...
                    <div onClick={playOpenhh} id="openhh" className="drum-pad btn">
                    ...
                    <div onClick={playKicknhat} id="kicknhat" className="drum-pad btn">
                    ...
                    <div onClick={playKick} id="kick" className="drum-pad btn">
                    ...
                    <div onClick={playClosedhh} id="closedhh" className="drum-pad btn">
